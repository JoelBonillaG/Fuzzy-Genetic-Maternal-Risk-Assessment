"""Algoritmo genetico binario con PyGAD.
...
def ejecutar_algoritmo_genetico(tabla, membresias, parametros, progress_callback=None):
    ...
    def registrar_generacion(generacion, poblacion):
        ...
        if mejor_resultado is None or balanced_accuracy > mejor_resultado.balanced_accuracy:
            estado["mejor_resultado"] = ResultadoAlgoritmoGenetico(
...
def evaluar_poblacion_por_recall_precision(
    ...
    """Evalua cada regla con la funcion de calidad usada por el experimento."""
