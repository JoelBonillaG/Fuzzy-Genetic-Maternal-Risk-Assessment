        ...
        resumen.append(
            {
                ...
                "reglas_unicas": len(reglas_unicas),
                "reglas_eliminadas": len(duplicadas),
                "low risk": contar_por_clase(reglas_unicas).get("low risk", 0),
                "mid risk": contar_por_clase(reglas_unicas).get("mid risk", 0),
                "high risk": contar_por_clase(reglas_unicas).get("high risk", 0),
