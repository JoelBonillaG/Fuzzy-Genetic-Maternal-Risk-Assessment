...
def crear_parser():
    ...
    parser.add_argument("--algoritmo", default=None, help="Filtra por algoritmo, por ejemplo AG_MICHIGAN_BINARIO.")
    return parser
...
def construir_resumen(filas: list[dict]):
    ...
    tabla_ag = tabla[tabla["algoritmo"] == "AG_MICHIGAN_BINARIO"]
